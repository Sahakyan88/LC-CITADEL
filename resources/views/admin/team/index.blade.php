        ...
        <script>
            $(document).ready(function() {
                ...
                $('#dataTable').on('click', '.item_edit', function (e) {
                    ...
                    itemPopup.setTitle('Edit Team');
                    itemPopup.load("{{route('aGetTeam')}}?id="+editId, function () {
                        this.open();
                    });
                });
                ...
                $('#add_item').on('click', function (e) {
                    ...
                    itemPopup.setTitle('Add Team');
                    itemPopup.load("{{route('aGetTeam')}}", function () {
                        this.open();
                    });
                });
