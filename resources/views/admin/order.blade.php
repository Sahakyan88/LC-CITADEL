                                            ...
                                            <div class="card-body">
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="customer" readonly disabled name="customer" type="text" value="(" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="employee">Employee</label>
                                                        <input class="form-control" id="employee" readonly disabled name="employee" type="text" value="(" />
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="price" readonly disabled name="price" type="text" value="" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="description">Description</label>
                                                        <textarea class="form-control" name="description" readonly disabled rows="3"></textarea>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
