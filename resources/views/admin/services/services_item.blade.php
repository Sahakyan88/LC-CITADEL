                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            <div class="image-upload-container" id="coverFile">
                                                <div class="image-part">
                                                    <a class="thumbnail"
                                                ...
                                                <div
                                                    ...
                                                    <div class="img-exist">
                                                        <span class="btn btn-danger remove-file">Remove file </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-12">
                                                                    ...
                                                                    <input class="form-control" id="title"
                                                                        name="title_{{ $lang['lang'] }}" type="text"
                                                                        placeholder="Title"
                                                                        value="{{ $item->$title }}" />
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-select form-control" name="published"
                                                            ...
                                                            <option @if ($item->published == 1) selected @endif
                                                                value="1">Active
                                                            </option>
                                                            <option @if ($item->published == 0) selected @endif
                                                                value="0">Disabled
                                                            </option>
                                                        </select>
                                                        </span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input class="admin_checkbox" value="1"
