        ...
        <script>
            $(document).ready(function() {
                ...
                $('#dataTable').on('click', '.item_edit', function (e) {
                    ...
                    itemPopup.setTitle('Edit About');
                    itemPopup.load("{{route('aGetAbout')}}?id="+editId, function () {
                        this.open();
                    });
                });
                ...
                $('#add_item').on('click', function (e) {
                    ...
                    itemPopup.setTitle('Add About');
                    itemPopup.load("{{route('aGetAbout')}}", function () {
                        this.open();
                    });
                });
