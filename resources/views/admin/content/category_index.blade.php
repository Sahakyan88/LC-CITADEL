...
<main>
    ...
    <div class="container mt-n10">
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group mb-10 col-md-2 float-right nopadding" style="margin-bottom: 10px!important;">
                    <select class="form-control" name="filter_status" id="filter_status">
                        <option value="" selected  >Select for ordering</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filter_status').change(function(){
                var parentId = $('#filter_status').val();
            ...
            $('#dataTable').on('click', '.item_edit', function (e) {
                ...
                itemPopup.load("{{route('aGetCategory')}}?id="+editId, function () {
                    this.open();
                });
            });
            ...
            $('#add_item').on('click', function (e) {
                ...
                itemPopup.setTitle('Add category');
                itemPopup.load("{{route('aGetCategory')}}", function () {
                    this.open();
                });
            });
