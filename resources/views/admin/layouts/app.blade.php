        ...
        <ul class="navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown no-caret mr-3 mr-lg-0 dropdown-user">
                <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage"
                    ...
                    aria-expanded="false"><img class="img-fluid" src="{{ asset('backend/img/profile.png') }}" /></a>
                <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up"
                    aria-labelledby="navbarDropdownUserImage">
                    <h6 class="dropdown-header d-flex align-items-center">
                        <img class="dropdown-user-img" src="{{ asset('backend/img/profile.png') }}" />
                        <div class="dropdown-user-details">
                            <div class="dropdown-user-details-name admin_name_lbl">
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <a class="nav-link @if (isset($menu) && $menu == 'team') active @endif"
                            href="{{ route('ateam') }}">
                            <div class="nav-link-icon"><i data-feather="users"></i></div>
                            Our Team
                        </a>
                        ...
                        <a class="nav-link @if (isset($menu) && $menu == 'packages') active @endif"
                            href="{{ route('packages') }}">
                            <div class="nav-link-icon"><i data-feather="dollar-sign"></i></div>
                            Packages Payments
                        </a>
